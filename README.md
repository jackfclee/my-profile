...
gantt
    ...
    section Coding IDE
        Borland JBuilder                   :done    ,            2001-03-07, 2003-03-01
        Oracle J-Developer                 :done    ,            2003-03-03, 2005-05-08
        IBM Rational Application Developer :done    ,            2005-05-09, 2015-06-30
        Eclipse                            :done    ,            2010-07-01, 2023-12-31
        Anypoint Studio                    :done    ,            2015-07-01, 2018-12-31
        IntelliJ IDEA                      :done    ,            2019-01-01, 2022-04-06
        Visual Studio Code                 :done    ,            2019-01-01, 2023-12-31
    section Coding Language
        ASP                                :done    ,            2000-05-29, 2001-01-31
        HTML                               :done    ,            2000-05-29, 2005-05-08
        JavaScript                         :done    ,            2000-05-29, 2005-05-08
        PERL/CGI                           :done    ,            2000-05-29, 2001-01-31
        PL/SQL                             :done    ,            2000-05-29, 2005-05-08
        Shell Scripting                    :done    ,            2000-05-29, 2010-06-30
        C                                  :done    ,            2001-02-01, 2001-03-06
        CSS                                :done    ,            2001-03-07, 2005-05-08
        Java                               :done    ,            2001-03-07, 2023-12-31
        Visual Basic                       :done    ,            2003-03-03, 2005-05-08
        Visual C++                         :done    ,            2003-03-03, 2005-05-08
        ...
        Groovy                             :done    ,            2021-01-01, 2022-04-06
        SQL                                :done    ,            2021-01-01, 2022-04-06
        Lua                                :done    ,            2022-01-01, 2022-04-06
    section Coding Framework
        J2EE                               :done    ,            2001-03-07, 2015-06-30
        Java Servlet                       :done    ,            2001-03-07, 2005-05-08
        JSP                                :done    ,            2001-03-07, 2005-05-08
        HSBC ES Framework                  :done    ,            2005-05-09, 2010-06-30
        Spring Core                        :done    ,            2010-07-01, 2015-06-30
        Spring Batch                       :done    ,            2011-01-01, 2015-06-30
        Spring Data                        :done    ,            2011-01-01, 2015-06-30
        Spring JMS                         :done    ,            2011-01-01, 2015-06-30
        Spring MVC                         :done    ,            2011-01-01, 2015-06-30
        ...
        Node.js                            :done    ,            2019-01-01, 2023-12-31
        Spring Reactive                    :done    ,            2019-01-01, 2022-04-06
        Spring JPA                         :done    ,            2021-01-01, 2022-04-06
        JavaPoet                           :done    ,            2022-07-04, 2023-08-25
        Maven MOJO Plugin                  :done    ,            2022-07-04, 2023-08-25
    section UI Development
        Macromedia Flash                   :done    ,            2000-05-29, 2001-01-31
        Java Swing                         :done    ,            2003-03-03, 2005-05-08
        Oracle Form & Report 6i            :done    ,            2003-03-03, 2005-05-08
    section Message Protocol
        HTTPS                              :done    ,            2000-05-29, 2023-12-31
        LDAP                               :done    ,            2001-02-01, 2001-03-06
        JDBC                               :done    ,            2001-03-07, 2022-04-06
        IBM MQ                             :done    ,            2005-05-09, 2022-04-06
        TCP stream                         :done    ,            2007-01-01, 2010-06-30
        Apache Kafka                       :done    ,            2022-11-01, 2023-03-31
    section Message Format
        SOAP/XML                           :done    ,            2003-03-03, 2023-12-31
        Fixed-length                       :done    ,            2005-05-09, 2022-04-06
        SWIFT                              :done    ,            2007-01-01, 2007-11-01
        REST/JSON                          :done    ,            2015-07-01, 2023-12-31
        HL7 & FHIR                         :done    ,            2023-08-28, 2023-12-31
    section Data Store
        MS SQL Server                      :done    ,            2000-05-29, 2003-03-01
        Oracle Database                    :done    ,            2001-03-07, 2011-06-30
...
gantt
    ...
    section Application Runtime
        ...
        BEA Weblogic                       :done    ,            2003-03-03, 2005-05-08
        IBM WAS                            :done    ,            2005-05-09, 2016-12-31
        IBM WMB/IIB                        :done    ,            2006-01-01, 2015-06-30
        Mule Runtime Engine                :done    ,            2016-01-01, 2022-04-06
        Lightbend Kalix                    :done    ,            2022-07-04, 2023-08-25
        MuleSoft CloudHub                  :done    ,            2023-08-28, 2023-12-31
    section Deployment Platform
        On-Perm (IBM WAS)                  :done    ,            2005-05-09, 2015-06-30
        Docker                             :done    ,            2017-01-01, 2023-12-31
        PCF IKP                            :done    ,            2017-01-01, 2019-12-31
        AWS EKS                            :done    ,            2020-01-01, 2023-12-31
        GCP GKE                            :done    ,            2023-08-28, 2023-12-31
    section Management Tool
        Wily                               :done    ,            2011-07-01, 2012-12-31
        MuleSoft API Gateway               :done    ,            2016-01-01, 2022-04-06
    ...
    section Other
        Sharepoint                         :done    ,            2005-05-09, 2023-12-31
        Confluence                         :done    ,            2017-01-01, 2023-12-31
        Jira                               :done    ,            2017-01-01, 2023-12-31
```
